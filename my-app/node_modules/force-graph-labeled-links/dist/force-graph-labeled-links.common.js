...
var CanvasForceGraph = Kapsule({
    ...
    methods: {
        ...
        d3Force: function d3Force$$1(state, forceName, forceFn) {
    ...
    stateInit: function stateInit() {
        return {
            forceLayout: d3Force.forceSimulation().force('link', d3Force.forceLink()).force('charge', d3Force.forceManyBody()).force('center', d3Force.forceCenter()).stop(),
            engineRunning: false
        };
    },
